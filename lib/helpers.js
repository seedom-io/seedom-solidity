...
module.exports.deployDir = 'deploy';
...
module.exports.getContractFile = (contractName) => {
    return path.join(this.contractDir, contractName) + '.' + this.contractExt;
}
...
module.exports.getDeployFile = (networkName) => {
    return path.join(this.deployDir, networkName + '.' + this.jsonExt);
}
